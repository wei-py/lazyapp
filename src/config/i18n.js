...
const chinese = {
  ...
  'Selected language: {language}': '所选语言：{language}',
  'Press Enter to apply and save your language preference.': '按 Enter 应用并保存语言偏好。',
  'Only interface text changes. Your workspace data is untouched.': '仅更改界面文字，不修改工作区数据。',
  ...
  'j/k language | Enter apply | Tab/1/2/3 panel | Esc back | ? help | q quit': 'j/k 语言 | Enter 应用 | Tab/1/2/3 面板 | Esc 返回 | ? 帮助 | q 退出',
  'App name': '应用名称',
  'Description': '描述',
  'Version': '版本',
  ...
  'The language preference is invalid or unsafe. Repair the settings file before retrying; it was not overwritten.': '语言偏好设置无效或不安全。请修复设置文件后重试；未覆盖此文件。',
  'j/k category | Enter to list | Tab/1/2/3 panel | ? help | q quit': 'j/k 分类 | Enter 列表 | Tab/1/2/3 面板 | ? 帮助 | q 退出',
  'Language preferences are being saved by another instance. Retry when it finishes.': '其他实例正在保存语言偏好设置。请等待完成后重试。',
